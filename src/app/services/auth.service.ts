...
export class AuthService {
  ...
  public getTokenDetail(): TokenDetail {
    ...
    tokenDetail.Token = sessionStorage.getItem("token");
    tokenDetail.RefreshToken = sessionStorage.getItem("refresh-jwt");
  ...
  public setRefreshToken(refreshToken: string): void {
    ...
    sessionStorage.setItem("refresh-jwt", refreshToken);
  }
